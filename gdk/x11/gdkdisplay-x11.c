                                ...
                                GdkWindowState *unset)
{
  ...
  local_set = *set;
  local_unset = *unset;
  constraints = toplevel->edge_constraints;
  ...
  if (type != None)
    {
      ...
      toplevel->edge_constraints = constraints[0];
